...
const PLUGIN_LIB_NANOS = { 'Cometh': Resolve('elfs/plugin_nanos.elf') };
const PLUGIN_LIB_NANOX = { 'Cometh': Resolve('elfs/plugin_nanox.elf') };
const PLUGIN_LIB_NANOSP = { 'Cometh': Resolve('elfs/plugin_nanosp.elf') };
